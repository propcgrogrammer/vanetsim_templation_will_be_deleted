...
public final class ConsoleStart implements Runnable {
	...
	public ConsoleStart(String mapFile, String scenarioFile, String simulationTime){
		...
		Debug.callFunctionInfo(this.getClass().getName(), "ConsoleStart(String mapFile, String scenarioFile, String simulationTime)", true);
	...
	public void run() {
		...
		Debug.callFunctionInfo(this.getClass().getName(), "run()", true);
