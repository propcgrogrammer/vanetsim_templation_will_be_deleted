...
public final class Junction {
	...
	public Junction(Node node, Street[] priorityStreets){
		...
		Debug.callFunctionInfo(this.getClass().getName(), "Junction(Node node, Street[] priorityStreets)", true);
	...
	public void writeQueueFile()
	{
		...
		try {
			...
			{
			     FILENAME = "Queue_" + new java.util.Date().getTime() + ".txt";
			}
			    
			    
			    Vehicle[] vehicles = junctionQueuePriority3_.getVehicles();
