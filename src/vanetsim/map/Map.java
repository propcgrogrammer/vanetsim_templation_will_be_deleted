...
public class Map{
	...
	public ArrayList<TrafficLight> getTrafficLightArray(){return trafficLights;}
	
	private ArrayList<Street> streets = new ArrayList<Street>();
	public ArrayList<Street> getAllMapStreets(){return streets;}
...
//			VanetSimStart.getTextArea().append("地圖資訊\n");
//			VanetSimStart.getTextArea().append("地圖寬度"+width_+"\n");
//			VanetSimStart.getTextArea().append("地圖高度"+height_+"\n");
//			VanetSimStart.getTextArea().append("分區寬度"+regionWidth_+"\n");
//			VanetSimStart.getTextArea().append("分區高度"+regionHeight_+"\n");
...
//			VanetSimStart.getTextArea().append("分區中.....\n");
//			VanetSimStart.getTextArea().append("分區配置：regionCountX_=>"+regionCountX_+" | regionCountY_=>"+regionCountY_+"\n");
//			VanetSimStart.getTextArea().append("總共分為 => "+ regionCountX_*regionCountY_ +"\n");
...
//				VanetSimStart.getTextArea().append("+------------------------------------+\n");
//				VanetSimStart.getTextArea().append("| 區域 ["+i+"]["+j+"]    \n");
//				Debug.debugInfo("TAG", "| 區域 ["+i+"]["+j+"]    \n", true);
//				VanetSimStart.getTextArea().append("+------------------------------------+\n");
				ArrayList<TrafficLight> trafficLightArray = regions_[i][j].calculateJunctions();
				
				for(TrafficLight trafficLight : trafficLightArray)
				{
					if(trafficLight != null) trafficLights.add(trafficLight);
				}
